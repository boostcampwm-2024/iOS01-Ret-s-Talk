...
protocol Persistable {
    ...
    /// - Returns: 추가된 데이터.
    func add<Entity>(contentOf entities: [Entity]) async throws -> [Entity] where Entity: EntityRepresentable
    ...
    func delete<Entity>(contentOf entities: [Entity]) async throws where Entity: EntityRepresentable
}
